-- ==========================================================
-- PUNTO 6: Procedimientos y Funciones (Al menos 8)
-- ==========================================================
...
-- ==========================================================
-- PUNTO 7: Disparadores (Triggers) (Al menos 4)
-- ==========================================================

-- 1. Trigger para actualizar la cantidad de colmenas en Apiarios al insertar en 'Tiene' (Instalación de colmena en apiario)
...
-- 2. Trigger para actualizar la cantidad de colmenas en Apiarios al eliminar de 'Tiene' (Retiro de colmena)
...
-- 3. Trigger para evitar asignar una reina con estado inactivo o muerta
...
-- 4. Trigger para evitar fechas de visita futuras, garantizando coherencia en los datos
